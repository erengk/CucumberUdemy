...
/*
Çarpım tablosu oluşturulacak
Bu çarpım tablosu her 1'den 9'a çarpım sonrası bir boşluk bırakarak yeni satırdan devam edecek
Çarpım tablosunu yeni bir excel dosyası oluşturarak kaydedecek program yazınız
 */
/*
İlk task içerisinde oluşturulan çarpım tablosunu altalta değil de yan yana yazan bir program yazınız
 */
public class _07_Task {
    ...
    public static void altaltaTablo() throws IOException {
